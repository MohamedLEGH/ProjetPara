target: decide decidev2 decideMPIv1 decideMPIv2 decideMP decideMPv2 decideMPv3 decideMPI_openMP
CC = gcc
MCC = mpicc
...
clean:
	rm -f *.o decideMPIv1 decideMPIv2 decideMP decide decidev2 decideMPv2 decideMPv3 decideMPI_openMP
